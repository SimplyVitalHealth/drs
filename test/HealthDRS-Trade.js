...
contract('HealthDRS :: Trade', function(accounts) {
  ...
  it('key owners should not be able to trade shared keys enabled for trade', async function() {
        ...
        await this.drs.createTradeOffer(key2, key1, {from: accounts[1]}).should.be.rejectedWith(Error)
        await this.drs.tradeKey(key1, key2).should.be.rejectedWith(Error)
  ...
  it('non-owners should not be able to trade keys', async function() {
    ...
    await this.token.transfer(accounts[1], 10000) //need hlth to create services and trade keys
    ...
    await this.drs.tradeKey(key1, key2, {from: accounts[1]}).should.be.rejectedWith(Error)
  ...
  it('creating a trade offer should negate an active sales offer', async function() {
    ...
    await this.drs.createTradeOffer(key0, key0)
